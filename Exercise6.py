# Rotate the key,value in a new dict value,key with the list in  new value for many times
buildings = {
...
d = {}
'''Δεύτερος τρόπος δημιουργίας νέου λεξικού
for building, country in buildings.items():
    d[country] = d.get(country, [])
    d[country].append(building)
'''
for building, country in buildings.items():
    if country not in d:
        d[country] = [building]
